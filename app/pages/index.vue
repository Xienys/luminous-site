    ...
    <UPage class="bg-[linear-gradient(to_right,#131316_1px,transparent_1px),linear-gradient(to_bottom,#131316_1px,transparent_1px)] bg-size-[24px_24px] -z-10">
        <UPageHeader class="border-none!">
            <UPageSection class="border-none!"
                title="LUMINOUS"
                :ui="{title: 'font-[Stopwatch] tracking-[.22em] sm:text-7xl! md:text-8xl! lg:text-9xl! xl:text-9xl text-6xl! pixel-shadow', wrapper: 'relative overflow-hidden', container: 'relative z-10'}">
        ...
        <UPageBody class="pt-10">
            ...
            <UContainer>
                ...
                <UContainer class="relative flex items-center justify-center gap-x-8 gap-y-4 p-4 sm:p-6">
                    <UPageCard class="font-[MinecraftTenLowercase] items-center min-w-120 min-h-60 max-w-160"
